...
def run_algorithm(Solution_no, Max_iter, F_name, max_runs=50):
    all_fitness = []
...
def main():
    ...
    # Save to CSV
    with open("CEC2017_RSA_PSO_results.csv", mode="w", newline="") as file:
        writer = csv.writer(file)
        writer.writerow(["Function", "Mean Fitness", "Std Deviation"])
        writer.writerows(results)

    print("\n✅ All results saved to 'CEC2017_RSA_PSO_results.csv'.")
